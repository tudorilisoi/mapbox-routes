...
const truckLocation = [-6.26031, 53.349805];
const warehouseLocation = [-6.26031, 53.349805];
...
async function addWaypoints(event, map) {
...
async function newDropoff(coordinates, map) {
...
function updateDropoffs(geojson, map) {
